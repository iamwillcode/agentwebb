          ...
          <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5">
            <div className="px-6 py-16 bg-gray-50 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
              <div className="max-w-lg mx-auto">
                ...
                <p className="mt-3 text-gray-500 body-large">
                  Nullam risus blandit ac aliquam justo ipsum. Quam mauris
                  volutpat massa dictumst amet. Sapien tortor lacus arcu.
                </p>
                <dl className="mt-8 text-gray-500 body-large">
                  <div>
                    <dt className="sr-only">Postal address</dt>
                    <dd>
                      <p className="body-large">742 Evergreen Terrace</p>
                      <p className="body-large">Springfield, OR 12345</p>
                    </dd>
                  </div>
                  <div className="mt-6">
      ...
      <div className="px-6 py-16 mx-auto max-w-7xl lg:px-8">
        <div className="max-w-lg mx-auto md:grid md:max-w-none md:grid-cols-2 md:gap-8">
          <div className="mt-12 sm:mt-16 md:mt-0">
            ...
            <p className="mt-1.5 body-large text-gray-50">
              Lorem, ipsum dolor sit amet5 consectetur adipisicing elit. Magni,
            ...
            <div className="mt-9">
              <div className="flex">
                ...
                <div className="ml-3 body-medium text-gray-50">
                  <p>+1 (555) 123 4567</p>
              ...
              <div className="flex mt-6">
                <div className="flex-shrink-0">
                  <HiMail className="w-6 h-6 text-gray-50" aria-hidden="true" />
                </div>
                <div className="ml-3 body-medium text-gray-50">
