    ...
    <>
      ...
      <main className="my-16 space-y-16">
        <section className="wrapper">
          <h1 className="font-bold display-small">Listings</h1>
          <p className="body-large max-w-[90ch] mt-2 text-lg text-gray-600 mb-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Possimus magnam inventore eum accusamus aut dicta! Sequi cupiditate laudantium, nemo, quisquam, libero ut temporibus voluptate eaque laboriosam eligendi perferendis aliquam quas.</p>
