const perks = [
  {
    name: 'Relestate Data Located In One Place',
...
const deciding_to_buy = [
  { title: "Things to consider when to buy a home.", path_name:"/docs/slug#article-name" },
  { title: "Sell Before You Buy.", path_name:"/docs/slugarticle-name" },
  { title: "Selecting An Agent.", path_name:"/docs/slugarticle-name" },
  { title: "Signing The Realtors Contract.", path_name:"/docs/slugarticle-name" },
  { title: "Getting Ready For Visiting.", path_name:"/docs/slugarticle-name" },
  { title: "Searching Properties.", path_name:"/docs/slugarticle-name" },
  { title: "Visiting Properties.", path_name:"/docs/slugarticle-name" },
  { title: "Picking One For Your Needs.", path_name:"/docs/slugarticle-name" },
  { title: "Makking The Offer.", path_name:"/docs/slugarticle-name" },
  { title: "Negotiating The Offer.", path_name:"/docs/slugarticle-name" },
  { title: "Making The Agreement to Purchase Firm..", path_name:"/docs/slugarticle-name" },
  { title: "Lawyers And Closing The Purchase..", path_name:"/docs/slugarticle-name" },
  { title: "Packing And Moving.", path_name:"/docs/slugarticle-name" },
  { title: "Additional Infromation.", path_name:"/docs/slugarticle-name" },
];
const articles = [
