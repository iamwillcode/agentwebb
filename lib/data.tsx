...
const deciding_to_buy = [
  { title: "Things to consider when to buy a home.", path_name:"/slug#article-name" },
  { title: "Sell Before You Buy.", path_name:"/slug#article-name" },
  { title: "Selecting An Agent.", path_name:"/slug#article-name" },
  { title: "Signing The Realtors Contract.", path_name:"/slug#article-name" },
  { title: "Getting Ready For Visiting.", path_name:"/slug#article-name" },
  { title: "Searching Properties.", path_name:"/slug#article-name" },
  { title: "Visiting Properties.", path_name:"/slug#article-name" },
  { title: "Picking One For Your Needs.", path_name:"/slug#article-name" },
  { title: "Makking The Offer.", path_name:"/slug#article-name" },
  { title: "Negotiating The Offer.", path_name:"/slug#article-name" },
  { title: "Making The Agreement to Purchase Firm..", path_name:"/slug#article-name" },
  { title: "Lawyers And Closing The Purchase..", path_name:"/slug#article-name" },
  { title: "Packing And Moving.", path_name:"/slug#article-name" },
